...
# https://hub.docker.com/r/hexpm/elixir/tags - for the latest images
...
# to be re-compiled.
COPY phoenix_draft/config/config.exs phoenix_draft/config/${MIX_ENV}.exs config/
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/predecessor_draft ./
